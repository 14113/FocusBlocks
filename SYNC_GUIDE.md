...
FocusBlocks nyní podporuje automatickou synchronizaci dat mezi více počítači pomocí Dropboxu. Všechna vaše data (dokončené bloky, časy a nastavení) jsou automaticky synchronizována bez nutnosti manuálního exportu/importu.
...
3. **Inteligentní slučování**: Pokud pracujete na dvou počítačích současně, aplikace chytře sloučí data
